...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.addEvt = function (info) {
        var _this = this;
        this.http.post('http://localhost:3000/add', info).subscribe(function (result) {
            _this.dataList.push(result);
        });
    };
    AppComponent.prototype.deleteEvt = function (item) {
        var _this = this;
        var id = item["_id"];
        this.http.delete('http://localhost:3000/delete/' + id).subscribe(function (result) {
            _this.dataList = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["remove"])(_this.dataList, function (n) {
                return n["_id"] != result;
            });
        });
    };
    AppComponent.prototype.updateEvt = function (item) {
        this.http.put('http://localhost:3000/update', item).subscribe(function (result) {
        });
    };
    AppComponent.prototype.displayRain = function () {
        this.dataList = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["remove"])(this.dataList, function (n) {
            return n["remove"] != true;
        });
    };
    AppComponent.prototype.testRain = function (id) {
        var _this = this;
        this.http.get('http://api.openweathermap.org/data/2.5/forecast?id=' + id + '&APPID=' + this.APIkey).subscribe(function (data) {
            var index = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"])(_this.dataList, { "cityId": id });
            var item;
            for (item = 0; item < data["list"].length; item++) {
                if (data["list"][item]["weather"][0]["main"] == "Rain") {
                    _this.dataList[index]["remove"] = false;
                    _this.dataList[index]["rainyTime"] = data["list"][item]["dt_txt"];
                    break;
                }
            }
        });
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('../assets/city.list.json').subscribe(function (data) {
            _this.cityList = data;
            _this.http.get('http://localhost:3000/data').subscribe(function (data) {
                _this.dataList = data.map(function (item) {
                    item["remove"] = true;
                    var index = Object(lodash__WEBPACK_IMPORTED_MODULE_5__["findIndex"])(_this.cityList, { "name": item["location"] });
                    if (index == -1) {
                        item.cityId = null;
                    }
                    else {
                        item.cityId = _this.cityList[index]["id"];
                        _this.testRain(item["cityId"]);
                    }
                    return item;
                });
            });
...
var AddComponent = /** @class */ (function () {
    ...
    AddComponent.prototype.toggleAptDisplay = function () {
        this.showForm = !this.showForm;
    };
    AddComponent.prototype.handleAdd = function (formInfo) {
        var tempItem = {
            name: formInfo.name,
...
var ChartComponent = /** @class */ (function () {
    ...
    ChartComponent.prototype.ngOnInit = function () {
        ...
        for (var i = 0; i < 4 && i < this.chartList.length; i++) {
...
var ListComponent = /** @class */ (function () {
    ...
    ListComponent.prototype.deleteItem = function (theApt) {
        this.deleteEvt.emit(theApt);
    };
    ListComponent.prototype.handleUpdate = function (item, labelName, newValue) {
        item[labelName] = newValue;
        console.log(item);
        this.updateEvt.emit(item);
    };
    ListComponent.prototype.displayRainy = function () {
        this.rainEvt.emit();
    };
